...
describe("Solana", () => {
    ...
    describe("Chain initialization", () => {
        it("should initialize with a nodejs provider", () => {
            ...
            expect(solana.renNetworkDetails.isTestnet).to.equal(true);
        });
        ...
        it("should be able to retrieve a burn", async () => {
            ...
            expect(burn.to).to.equal("2N6vHZjmFufphgEGvSttCW1SGbbpvHPGfGA");
            expect(burn.amount.toString()).to.equal("20000");
        });
