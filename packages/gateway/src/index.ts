...
export class Gateway {
    ...
    constructor(network: RenNetwork, config: GatewayJSConfig) {
        this.logger =
    ...
    public readonly _open = (
        transferParams: TransferParams | LockAndMintEvent | BurnAndReleaseEvent,
                ...
                case GatewayMessageType.FindMintTransaction:
                    (async () => {
                        try {
                            ...
                            >;
                            const txHash = undefined; /* await findTransactionBySigHash(
                                this.network,
                                this.web3,
                                token,
                                sigHash,
