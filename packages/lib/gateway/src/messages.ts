...
> = Type extends GatewayMessageType.ToggleSettings
    ...
    ? {}
    : Type extends GatewayMessageType.Transfers
    ...
    ? {}
    : Type extends GatewayMessageType.TransferUpdated
...
export type GatewayMessageResponse<Type extends GatewayMessageType> =
    ...
    Type extends GatewayMessageType.GetStatus
        ...
        : Type extends GatewayMessageType.GetEthereumTxStatus
        ? { confirmations?: number; reverted: boolean; error?: string }
        : Type extends GatewayMessageType.GetEthereumTxBurn
        ? { burnReference?: string | number; error?: string }
        : Type extends GatewayMessageType.FindMintTransaction
        ? { txHash?: string | undefined; error?: string }
        : Type extends GatewayMessageType.RequestNotificationPermission
        ? { error?: string }
        : never;
