...
const testnet: NetworkData = {
    ...
    addresses: OrderedMap({
        ...
        [Category.RenEx]: OrderedMap({
            ...
            RenExTokens: { address: "0x0649b5dfca237d67e72508333616e4cd330c6f89", version: "0.1.0" },
        ...
        [Category.Tokens]: OrderedMap({
            ...
            ABC: { address: "0xfc42491547f1837e2d0f9a0e6b12b1d883fb8bd0", version: "0.1.0" },
            PQR: { address: "0x724c964a614Eb0748b48dF79eD5D93C108E361c4", version: "0.1.0" },
            XYZ: { address: "0xc9382f7b2c683e08aade773eb97bce4a0d6461a0", version: "0.1.0" },
        }),
    }),
};
