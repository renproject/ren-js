...
import { renChaosnet, renDevnet, renLocalnet, renTestnet } from "@renproject/networks";
import {
...
describe("Utils", function () {
    ...
    const testcases = [
        ...
        { name: "chaosnet", network: renChaosnet, expectedHash: "0x94e6111ba16ef879b33de88e4a8f98f11211721983dde525d9922e7ac33dc64a", expectedAddress: "36PoEz39mnYmWC3WGdiFyKAmCtRTTunzs3" },
        { name: "testnet", network: renTestnet, expectedHash: "0xd63c52983659035b6d092dfa5c1eee81b968caf8d97d90a3b58ed61dedcd59a3", expectedAddress: "2Mtc7uY9qrsfuP1WpPLzLNc9nR4DXvs5icg" },
        { name: "devnet", network: renDevnet, expectedHash: "0x4793980dbae1228bbd5df742b892a348006fd4dc3553e4b3afa94c4629b2ba7a", expectedAddress: "2NE1UpF7AatbiiuJDhruSCN3RfcDbdPnPyd" },
        { name: "localnet", network: renLocalnet, expectedHash: "0x685725b3d6d11d846be676b26f9357543e6d18044e6b09ca2b3af0f96e5e8d2b", expectedAddress: "2N3NC9ERzWj6sY49z6LZM1TLGj9bzvke8Ma" },
    ];
