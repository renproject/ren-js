 ...
 */
export const HandlingBurn: React.FC<Props> = ({ onDone, pressedDone, showNotification, requestNotificationPermission }) => {
    const {
    ...
    switch (transfer.status) {
        ...
        case BurnAndReleaseStatus.SubmittedToRenVM:
            inner = <SubmitBurnToRenVM token={token} mini={paused} renVMStatus={renVMStatus} txHash={txHash} submitDeposit={submitBurnToRenVM} />;
            break;
