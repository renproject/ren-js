...
var _this = this;
var RenJS = require("@renproject/ren")["default"];
(function () { return __awaiter(_this, void 0, void 0, function () {
    var arg, darknode;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                arg = function (name, type, value) { return ({ name: name, type: type, value: value }); };
                darknode = new RenJS.Darknode("127.0.0.1:6001");
                return [4 /*yield*/, darknode.submitTx({
