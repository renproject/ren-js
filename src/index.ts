...
export default class RenSDK {
    ...
    public burnDetails = (params: BurnParams): PromiEvent<ShiftedOutResponse> => {
        ...
        (async () => {
            ...
            return await this.shifter.waitForResponse(messageID) as ShiftedOutResponse;
...
export class ShiftObject {
    ...
    public wait = (confirmations: number): PromiEvent<this> => {
        ...
        (async () => {
            ...
            while (true) {
                ...
                try {
                    const newDeposits = await retrieveDeposits(this.shiftDetails.network, this.shiftDetails.shiftAction, this.shiftDetails.gatewayAddress, confirmations);
    ...
    public submit = (): PromiEvent<Signature> => {
        ...
        (async () => {
            ...
            return new Signature(this.shiftDetails, response, messageID);
        })().then(promiEvent.resolve).catch(promiEvent.reject);
